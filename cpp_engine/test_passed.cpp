...
int main() {
    ...
    Bitboard w_pawns = b.pieces(PieceType::PAWN, Color::WHITE);
    Bitboard b_pawns = b.pieces(PieceType::PAWN, Color::BLACK);
    
    std::cout << "White Pawns:\n"; print_bb(w_pawns.getBits());
    std::cout << "Black Pawns:\n"; print_bb(b_pawns.getBits());
    ...
    while (temp_b) {
        ...
        std::cout << "Black Pawn at f=" << f << " r=" << r << "\n";
        std::cout << "Mask & w_pawns: " << (mask & w_pawns.getBits()) << "\n";
