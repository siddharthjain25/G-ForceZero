...
RUN g++ -O3 -march=native -flto -pthread -std=c++17 -I Fathom/src nnue_engine.cpp nnue.cpp Fathom/src/tbprobe.c -o nnue_engine
...
RUN mkdir -p /app/lichess-bot/syzygy
